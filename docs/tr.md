...
| Позиция | TeamLead             | Участник          |
| ------- | -------------------- | ----------------- |
| Имя     | Скородумов Владислав | Никитин Александр |
...
| **check_out**             | Дата выезда (не включительно)                                              |
| **adults**                | Параметр количества взрослых в номере                                      |

---

## Функциональные требования (MVP)
1. Поиск доступности по параметрам: check_in, check_out, room_type_id, adults.  
